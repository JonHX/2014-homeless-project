  jQuery(document).ready(function($){
      ...
      // The original code is provided with a free to use opensource by http://www.shinyface.com/2010/09/04/simple-parallax-with-jquery/ http://en.wikipedia.org/wiki/MIT_License
